...
const_eq = MathTex(r"dS = "+str(ds), font_size=8)
surf_eq = MathTex(r"\mathbf{r}(u, v) = \langle u, v, 2-u^2-v^2 \rangle", font_size=8)
partial_u = MathTex(r"\mathbf{r}_u = \langle 1, 0, -2u \rangle", font_size=8)
partial_v = MathTex(r"\mathbf{r}_v = \langle 0, 1, -2v \rangle", font_size=8)
#
##############################################################
